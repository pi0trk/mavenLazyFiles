...
mvn archetype:generate -DgroupId=pl.pi0trk -Dversion=0.1 -DartifactId=$project_name -DarchetypeArtifactId=maven-archetype-quickstart -DarchetypeVersion=1.4 -DinteractiveMode=false
...
# Remove AppTest
rm -f $project_name/src/test/java/pl/pi0trk/AppTest.java

# Create project description in main App
sed -i "s/* Hello world\!/* $project_description \n *\n * @author pi0trk/" $project_name/src/main/java/pl/pi0trk/App.java
